...
async def test_register_user(
    email, password, confirm_password, first_name, last_name, users_count, status_code, ac: AsyncClient
):
...
async def test_login_user(email, password, status_code, profile_status_code, ac: AsyncClient):
